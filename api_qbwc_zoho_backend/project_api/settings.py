...
MAIN_LOAD_URL_READ_INVOICES = env('MAIN_LOAD_URL_READ_INVOICES')
MAIN_LOAD_URL_READ_CUSTOMERS = env('MAIN_LOAD_URL_READ_CUSTOMERS')
MAIN_LOAD_URL_READ_ITEMS = env('MAIN_LOAD_URL_READ_ITEMS')
MAIN_LOAD_API_TOKEN = env('MAIN_LOAD_API_TOKEN')
