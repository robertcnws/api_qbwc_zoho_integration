                                        ...
                                        {/* {(() => {
                                            ...
                                            return (
                                                <TableCell
                                                    onClick={
                                                        matchedZohoCustomer
                                                            ? () => handleViewCustomer(matchedZohoCustomer)
                                                            : null
                                                    }
                                                    sx={{ color: cellColor }}
                                                >
                                                    <Tooltip title={matchedZohoCustomer ? 'Go to Zoho Customer Details' : ''} arrow>
                                                        {customer.fields.list_id
                                                            ? (matchedZohoCustomer?.fields?.contact_name || 'N/A')
                                                            : 'N/A'
                                                        }
                                                    </Tooltip>
                                                </TableCell>
